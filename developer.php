...
<?php //bloginfo('template_url'); ?><!--/assets/-->
    <div class="container developer_block wow fadeIn">
        ...
        <div class="header">
            <div class="main_name">
                ...
                <div class="name_box">
                    ...
                    <span><h1><?_e('developer','happy-house');?></h1></span>
        ...
        <div class="wrapper">
            <div class="line_link">
                <a href="/" class="link_active"><?php _e('breadcr-1','happy-house');?></a>&#8195;|&#8195;<span class="link_no_active"><?_e('developer','happy-house');?></span>
            </div>
            ...
            <div class="developer_box flex">
                <div class="developer_logo">
                    <a href="http://saga-development.com.ua/" class="develop__img" title="Saga Development">
                        <img src="<?php bloginfo('template_url'); ?>/assets/img/logos/saga-logo.svg" alt="Saga Development">
                    </a>
                </div>
