...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Планування квартири Happy House</title>
  ...
  <body>
    ...
    <div class="container flatplan_block">
      ...
      <div class="header">
        <div class="main_name">
          ...
          <div class="name_box">
            ...
            <span>Квартира <span id="NumberOfFlat">5B</span></span>
      ...
      <!-- end header -->
        ...
        <div class="wrapper">
          <div class="line_link">
            ...
            <a href="/" class="link_active">Обрати квартиру</a>&#8195;|&#8195;
            <span class="link_no_active">Квартира <span id="NumberOfFlat">5B</span></span>
          </div>


          <div class="flatplan__info flex">

            <div class="flatplan__info__item flex">
              <div class="flatplan_btn">
                <a href="/filter.php" class="flex btn_transparent">
                ...
                <a href="#" class="flex btn_transparent" download>
              ...
              <div class="flatplan_floor">
                <p>План поверху</p>
                <img src="/img/floor-plan/plan1.png" alt="">
              </div>
            </div>


            <div class="flatplan__info__item flatplan_center">
                <img src="/img/filter/Plan.png" alt="План квартири Happy House">
            </div>

            <div class="flatplan__info__item flex">
              <img class="is_desktop" src="/img/compas.png" alt="compas">
              <div class="btn_red">Дізнатся ціну </div>
            </div>
          ...
          <div class="flats_about flex">
            ...
            <div class="flats_about_name">Параметры <br class="is_desktop">квартиры</div>
            <div class="flats_about__line">
              <ul class="flats__slider">
                <li>
                  <span class="flats_param_num">54,89 м.кв </span> Загальна
                </li>
                <li>
                  <span class="flats_param_num">34,87 м.кв </span> Житлова
                </li>
                <li>
                  <span class="flats_param_num">5,89 м.кв</span> Передпокій
                 </li>
                <li>
                  <span class="flats_param_num">14,9 м.кв</span>  Кухня
                 </li>
                <li>
                  <span class="flats_param_num">24,6 м.кв</span>  Вітальня
                 </li>
                <li>
                  <span class="flats_param_num">4,1 м.кв </span>  Санвузол
                </li>
                <li>
                  <span class="flats_param_num">12,8 м.кв</span> Спальня
                 </li>
              </ul>
            </div>
          </div>
