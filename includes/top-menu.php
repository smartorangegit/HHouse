...
<div class="top-menu">
  <div class="wrapper flex">
    ...
    <div class="top-menu__right flex">
      ...
      <div id="phone_call" class="top-menu__item menu__link top-menu__link" style="flex-direction: row; -webkit-flex-direction: row;">
  ...
  <nav role="navigation">
    ...
    <ul>
      ...
      <li class="nav_item">
        ...
        <ul>
          <li><a href="#">Про Happy House</a></li>
      ...
      <li class="nav_item">
        ...
        <ul>
          <li><a href="#">Обрати за поверхом</a></li>
          <li><a href="#">Обрати за параметрами</a></li>
          <li><a href="#">1-кімнатні</a></li>
          <li><a href="#">2-кімнатні</a></li>
          <li><a href="#">3-кімнатні</a></li>
          <li><a href="#">4-кімнатні</a></li>
          <li><a href="#">Спеціальні умови</a></li>
