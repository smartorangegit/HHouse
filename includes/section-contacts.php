  ...
  <div class="wrapper">
    <div class="tabs">
       <ul class="tabs__name flex">
         <li>Наші контактні дані</li>
         <li>Замовити дзвінок</li>
         <li>Форма обратного зв&prime;язку</li>
       </ul>
         <div class="tabs__content">
           ...
           <div class="tabs__inner">
            ...
            <form id="" class="contact_form" action="3" method="post">
              ...
              <div class="input_wrapper ">
                  <input class="js-input-message" type="text" name="message" placeholder="О котрій годині вам зателефонувати?">
                  <div class="form__img">
           ...
           <div class="tabs__inner">
            ...
            <form id="" class="contact_form">
                ...
                <div class="input_wrapper required_input">
                    <input class="js-input-email" type="email" name="email" placeholder="Ваш e-mail:" data-required="true">
                    <div class="validation-error validation-error_required" style="display: none">Данне поле обов'язкове для заповнення</div>
                ...
                <div class="input_wrapper ">
                    <input class="js-input-message" type="text" name="message" placeholder="Ваше питання:">
                    <div class="form__img">
