       ...
       <ul class="tabs__name flex">
         ...
         <div class="tabs__content">
             ...
             <div class="content_subname">
               ...
               <form id="callback-form-local" class="contact_form" onsubmit="ajax_form(this)">
                   <div class="input_wrapper required_input">
                       <input class="js-input-name" type="text" name="name" required placeholder="<?_e('form-1','happy-house');?>" data-required="true" onkeyup="javascript:countme('callback-form-local');">
           ...
           <div class="tabs__inner">
            ...
            <form id="feedback-form-local" class="contact_form" onsubmit="ajax_form(this)">
                <div class="input_wrapper required_input">
                ...
                <div class="input_wrapper required_input">
                    <input class="js-input-email" type="email" name="email" required placeholder="Ваш e-mail:" data-required="true" onkeyup="javascript:countme('feedback-form-local');">
                    <div class="validation-error validation-error_required" style="display: none">Данне поле обов'язкове для заповнення</div>
                ...
                <input  type="hidden" name="phone" required  data-required="true" >
                <input  name="typ" class="webad" type="hidden" value="1" >
                <input  name="webad" class="webad" type="hidden" value="<?=$webAd;?>"/>
                <input  name="metka" class="metka" type="hidden" value="Форма обратной связи - Happy-House"/>
                <input  name="inn" class="userInn" type="hidden" value="Happy-House"/>
                <input type="submit" value="<?_e('form-submit','happy-house');?>" class="contacts__tab-submit-btn">
            </form>
           </div>
