...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="container advantages_block">
      ...
      <!-- end header -->
        ...
        <div class="wrapper">
          <div class="line_link">
            <a href="/" class="link_active">Головна</a>&#8195;|&#8195;<span class="link_no_active">Новини</span>
          </div>
          ...
          <section class="news_block flex">
            ...
            <div class="block_double news_item__3">
              <div class="block__name">
                Заголовок, назва новини, максимум в два рядки
                <div class="icon_line_box">
                  <svg class="icon_line"><use xlink:href="#line"></use></svg>
            ...
            <div class="block_double news_item__4">
              <div class="block__name">
                Заголовок, назва новини, максимум в два рядки
                <div class="icon_line_box">
                  <svg class="icon_line"><use xlink:href="#line"></use></svg>
