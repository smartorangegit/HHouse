function mapMaker(id, longt, lat) {
	...
	var
		...
		contentString3 = '<div class="map__info-marker">Берестейская</div>',
		contentString4 = '<div class="map__info-marker">Специализированная школа №82</div>',
		contentString5 = '<div class="map__info-marker">Веревочный парк</div>',
		contentString6 = '<div class="map__info-marker">Киевская детская железная дорога</div>',
		contentString7 = '<div class="map__info-marker">Сырецький парк</div>',
		contentString8 = '<div class="map__info-marker">КНЭУ</div>';
		contentString10 = '<div class="map__info-marker">Шулявская</div>';
		contentString11 = '<div class="map__info-marker">Парк имени Пушкина</div>';
		contentString12 = '<div class="map__info-marker">Киевский зоопарк</div>';
		contentString13 = '<div class="map__info-marker">Политехнический институт</div>';
		contentString14 = '<div class="map__info-marker">НМУ</div>';
		contentString15 = '<div class="map__info-marker">Парк КПИ</div>';
		contentString16 = '<div class="map__info-marker">ТЦ "Аркадия"</div>';
		contentString17 = '<div class="map__info-marker">ТЦ "Мармелад"</div>';
		contentString18 = '<div class="map__info-marker">ТЦ "Космополит"</div>';
		...
		contentString22 = '<div class="map__info-marker">Парк “Отрадний”</div>';
		contentString23 = '<div class="map__info-marker">Отдел продаж ЖК <p>Адрес: проспект Победы, 67 </p></div>';
...
// 50.437010, 30.541347
	...
	var locations = [
        ...
        [contentString23, 50.457989, 30.405916, "/wp-content/themes/happy-house/assets/img/map/pin_sale.png"],
